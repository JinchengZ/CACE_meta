...
write.table(summary(samps.m6a$samples)[[1]], "../outputs/out1_6a.txt", sep="\t")
write.table(summary(samps.m6a$samples)[[2]], "../outputs/out2_6a.txt", sep="\t")

out3_6a <- rep(NA, 3)
out3_6a[1] <- samps.m6a$dic[[1]] # mean deviance
out3_6a[2] <- samps.m6a$dic[[2]] # pD
out3_6a[3] <- samps.m6a$dic[[1]] + samps.m6a$dic[[2]]  # DIC
write.table(out3_6a, "../outputs/out3_6a.txt", sep="\t")
...
write.table(summary(samps.m6b$samples)[[1]], "../outputs/out1_6b.txt", sep="\t")
write.table(summary(samps.m6b$samples)[[2]], "../outputs/out2_6b.txt", sep="\t")

out3_6b <- rep(NA, 3)
out3_6b[1] <- samps.m6b$dic[[1]] # mean deviance
out3_6b[2] <- samps.m6b$dic[[2]] # pD
out3_6b[3] <- samps.m6b$dic[[1]] + samps.m6b$dic[[2]]  # DIC
write.table(out3_6b, "../outputs/out3_6b.txt", sep="\t")
...
write.table(summary(samps.m7a$samples)[[1]], "../outputs/out1_7a.txt", sep="\t")
write.table(summary(samps.m7a$samples)[[2]], "../outputs/out2_7a.txt", sep="\t")

out3_7a <- rep(NA, 3)
out3_7a[1] <- samps.m7a$dic[[1]] # mean deviance
out3_7a[2] <- samps.m7a$dic[[2]] # pD
out3_7a[3] <- samps.m7a$dic[[1]] + samps.m7a$dic[[2]]  # DIC
write.table(out3_7a, "../outputs/out3_7a.txt", sep="\t")
...
write.table(summary(samps.m4a_s1$samples)[[1]], "../outputs/out1_4a_s1.txt", sep="\t")
write.table(summary(samps.m4a_s1$samples)[[2]], "../outputs/out2_4a_s1.txt", sep="\t")

out3_4a_s1 <- rep(NA, 3)
out3_4a_s1[1] <- samps.m4a_s1$dic[[1]] # mean deviance
out3_4a_s1[2] <- samps.m4a_s1$dic[[2]] # pD
out3_4a_s1[3] <- samps.m4a_s1$dic[[1]] + samps.m4a_s1$dic[[2]]  # DIC
write.table(out3_4a_s1, "../outputs/out3_4a_s1.txt", sep="\t")

################# Model 4 a) Sens 2 ######################################################
jags.m4a_s2 <- jags.model(file="../models/m4a_s2.txt", data=data, inits=init.jags, n.chains=n.chains, n.adapt=n.adapt)
update(jags.m4a_s2, n.iter=n.burnin) # burn in
samps.m4a_s2 <- coda.samples.dic(jags.m4a_s2, variable.names=params, n.iter=n.iter, thin=n.thin)

write.table(summary(samps.m4a_s2$samples)[[1]], "../outputs/out1_4a_s2.txt", sep="\t")
write.table(summary(samps.m4a_s2$samples)[[2]], "../outputs/out2_4a_s2.txt", sep="\t")

out3_4a_s2 <- rep(NA, 3)
out3_4a_s2[1] <- samps.m4a_s2$dic[[1]] # mean deviance
out3_4a_s2[2] <- samps.m4a_s2$dic[[2]] # pD
out3_4a_s2[3] <- samps.m4a_s2$dic[[1]] + samps.m4a_s2$dic[[2]]  # DIC
write.table(out3_4a_s2, "../outputs/out3_4a_s2.txt", sep="\t")
...
out3_6a <- read.table('../outputs/out3_6a.txt')
out3_6b <- read.table('../outputs/out3_6b.txt')
out3_7a <- read.table('../outputs/out3_7a.txt')
out3_4a_s1 <- read.table('../outputs/out3_4a_s1.txt')
out3_4a_s2 <- read.table('../outputs/out3_4a_s2.txt')
...
out3_7 <- out3_7a
out4_sens <- cbind(out3_4a, out3_4a_s1, out3_4a_s2)
...
write.table(out3_6, "../outputs/out3_m6.txt", sep="\t")
write.table(out3_7, "../outputs/out3_m7.txt", sep="\t")
write.table(out4_sens, "../outputs/out4_sens.txt", sep="\t")
