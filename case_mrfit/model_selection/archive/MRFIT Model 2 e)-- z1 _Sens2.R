...
################# rjags code #########################################################
jags.m2e_s2 <- jags.model(file="MRFIT_m2e_s2.txt", data=data, inits=Inits, n.chains=2, n.adapt=2000)
update(jags.m2e_s2, n.iter=5000) # burn in
samps.m2e_s2 <- coda.samples.dic(jags.m2e_s2, variable.names=params, n.iter=20000, thin=5)
