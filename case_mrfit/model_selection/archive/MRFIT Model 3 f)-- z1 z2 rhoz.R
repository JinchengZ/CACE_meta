...
################# rjags code #########################################################
jags.m3f <- jags.model(file="MRFIT_m3f.txt", data=data, inits=Inits, n.chains=2, n.adapt=2000)
update(jags.m3f, n.iter=5000) # burn in
samps.m3f <- coda.samples.dic(jags.m3f, variable.names=params, n.iter=20000, thin=5)
